...
public enum ErrorCode {
    ...
    "ORDER_STATUS_CONFLICT", HttpStatus.CONFLICT, "주문 상태가 변경되어 결제를 진행할 수 없습니다. 주문 상태를 다시 확인해 주세요."),
    ...
    // ------------------결제 생성 관련 에러------------------
    PAYMENT_CREATE_FAILED("PAYMENT_CREATE_FAILED", HttpStatus.INTERNAL_SERVER_ERROR, "결제 생성이 실패했습니다."),
    ...
    INVALID_PAYMENT_REQUEST("INVALID_PAYMENT_REQUEST", HttpStatus.BAD_REQUEST, "결제수단에 맞지 않는 결제 요청입니다."),
    TOSS_PAYMENT_AUTH_REQUIRED("TOSS_PAYMENT_AUTH_REQUIRED", HttpStatus.BAD_REQUEST, "토스 결제 인증 정보가 필요합니다."),
    TOSS_PAYMENT_APPROVAL_FAILED("TOSS_PAYMENT_APPROVAL_FAILED", HttpStatus.CONFLICT, "토스페이먼츠 결제 승인이 실패했습니다."),
    TOSS_PAYMENT_KEY_MISMATCH("TOSS_PAYMENT_KEY_MISMATCH", HttpStatus.CONFLICT, "토스 결제 키가 요청 정보와 일치하지 않습니다."),
    TOSS_ORDER_ID_MISMATCH("TOSS_ORDER_ID_MISMATCH", HttpStatus.BAD_REQUEST, "토스 주문번호가 주문 정보와 일치하지 않습니다."),
    TOSS_PAYMENT_AMOUNT_MISMATCH("TOSS_PAYMENT_AMOUNT_MISMATCH", HttpStatus.BAD_REQUEST, "토스 결제 금액이 주문 금액과 일치하지 않습니다."),
