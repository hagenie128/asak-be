...
public enum ErrorCode {
        ...
        ORDER_INITIAL_STATUS_NOT_FOUND("ORDER_INITIAL_STATUS_NOT_FOUND", HttpStatus.INTERNAL_SERVER_ERROR,
        ...
        ORDER_EXCLUSION_CREATE_FAILED(
                        "ORDER_EXCLUSION_CREATE_FAILED", HttpStatus.INTERNAL_SERVER_ERROR,
        ...
        ORDER_REFUND_NOT_ALLOWED(
                        "ORDER_REFUND_NOT_ALLOWED", HttpStatus.CONFLICT, "주문을 환불할 수 없는 상태입니다."),
