 ...
 *
 * <p>
 * {@code code} is a stable API contract value; {@code status} is the HTTP
 * response status.
 */
public enum ErrorCode {
    ...
    // 주문 - 상태 변경 / 취소 / 환불
    // =========================================================
    ORDER_STATUS_NOT_FOUND("ORDER_STATUS_NOT_FOUND", HttpStatus.NOT_FOUND, "주문 상태를 찾을 수 없습니다."),
    ...
    ORDER_ALREADY_CANCELED("ORDER_ALREADY_CANCELED", HttpStatus.CONFLICT, "주문이 이미 취소되었습니다."),

    ORDER_CANCEL_NOT_ALLOWED("ORDER_CANCEL_NOT_ALLOWED", HttpStatus.CONFLICT, "주문을 취소할 수 없는 상태입니다."),

    ORDER_PAYMENT_APPROVED_CANCEL_NOT_ALLOWED(
            "ORDER_PAYMENT_APPROVED_CANCEL_NOT_ALLOWED", HttpStatus.CONFLICT, "결제 완료된 주문은 취소할 수 없습니다."),

    ORDER_COMPLETED_CANCEL_NOT_ALLOWED(
            "ORDER_COMPLETED_CANCEL_NOT_ALLOWED", HttpStatus.CONFLICT, "완료된 주문은 취소할 수 없습니다."),

    ORDER_REFUND_NOT_ALLOWED("ORDER_REFUND_NOT_ALLOWED", HttpStatus.CONFLICT, "주문을 환불할 수 없는 상태입니다."),

    ORDER_CANCEL_FAILED("ORDER_CANCEL_FAILED", HttpStatus.INTERNAL_SERVER_ERROR, "주문 취소에 실패했습니다."),

    // =========================================================
    // 결제 - 결제수단 / 요청 검증
    // =========================================================
    PAYMENT_METHOD_NOT_FOUND("PAYMENT_METHOD_NOT_FOUND", HttpStatus.NOT_FOUND, "결제수단 목록을 찾을 수 없습니다."),

    PAYMENT_METHOD_UPDATE_FAILED(
            "PAYMENT_METHOD_UPDATE_FAILED", HttpStatus.INTERNAL_SERVER_ERROR, "결제수단 수정에 실패했습니다."),
    ...
    PAYMENT_METHOD_NOT_SUPPORTED("PAYMENT_METHOD_NOT_SUPPORTED", HttpStatus.BAD_REQUEST, "지원하지 않는 결제 수단입니다."),

    PAYMENT_METHOD_STATUS_NOT_FOUND("PAYMENT_METHOD_STATUS_NOT_FOUND", HttpStatus.NOT_FOUND, "결제 상태를 찾을 수 없습니다."),

    PAYMENT_METHOD_STATUS_UPDATE_FAILED("PAYMENT_METHOD_STATUS_UPDATE_FAILED", HttpStatus.INTERNAL_SERVER_ERROR,
            "결제 상태 수정에 실패했습니다."),

    AMOUNT_INVALID_NOT_ALLOWED("AMOUNT_INVALID_NOT_ALLOWED", HttpStatus.BAD_REQUEST, "결제 금액이 유효하지 않습니다."),
    ...
    SALES_MONTH_INVALID("SALES_MONTH_INVALID", HttpStatus.BAD_REQUEST, "월은 1~12만 허용됩니다."),
