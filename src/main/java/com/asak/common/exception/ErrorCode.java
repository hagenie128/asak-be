...
public enum ErrorCode {
    ...
    ORDER_PAYMENT_APPROVED_CANCEL_NOT_ALLOWED("ORDER_PAYMENT_APPROVED_CANCEL_NOT_ALLOWED", HttpStatus.CONFLICT,
            "결제 완료된 주문은 취소할 수 없습니다."),
    ORDER_COMPLETED_CANCEL_NOT_ALLOWED("ORDER_COMPLETED_CANCEL_NOT_ALLOWED", HttpStatus.CONFLICT,
            "완료된 주문은 취소할 수 없습니다."),
