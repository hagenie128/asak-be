...
public class GlobalExceptionHandler {
   ...
   *
   * <p>이전에는 catch-all 로 떨어져 500 "서버 오류가 발생했습니다."가 나갔다. 서버는 멀쩡한데 고장난 것처럼 보여 원인 추적이
   * 어려웠다. 클라이언트 잘못이므로 400으로 돌려주고, 어떤 파라미터가 빠졌는지 알린다.
   */
  ...
  /**
   * 요청 파라미터 타입 불일치. 예: year=2026 이어야 하는 자리에 year=abc 가 온 경우. 날짜·기간 필터에서 형식이 어긋날 때
   * 이 경로로 들어온다.
   */
