...
| 문서 | 역할 |
|---|---|
| [GitHub Issues 가이드](02-github-issues-guide.md) | Issue·브랜치 작업 참고 |
| [팀 AI 프롬프트](06-team-ai-prompt.md) | 참고용 프롬프트 |
| [프론트 개발 가이드 이동 안내](07-frontend-development-guide.md) | 중앙 구현 가이드 링크 |
| [백엔드 개발 가이드 이동 안내](08-backend-development-guide.md) | API·DB 구현 가이드 링크 |
| [구 가이드 09~11 이동 안내](09-11-moved.md) | 통합 문서 위치 |
...
중앙 Product Bible과 WBS는 `C:\ASAK-workspace\ASAK\docs\`에서 확인합니다. 이 저장소의 복사본이나 날짜가 붙은 상태 문서는 현재 완료 상태를 자동으로 의미하지 않습니다.
